...
Usage: node scripts/view-weaviate-content.js [options]
...
Examples:
  ...
  node scripts/view-weaviate-content.js --type Concept --limit 50
  node scripts/view-weaviate-content.js --after 2025-08-20 --type MemoryUnit
  node scripts/view-weaviate-content.js --format table --content-length 100
  node scripts/view-weaviate-content.js --format json --limit 10
        `);
        process.exit(0);
        break;
