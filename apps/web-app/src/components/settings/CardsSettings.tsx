  ...
  return (
    <div className="space-y-4">
      ...
      <div className="pt-3 border-t border-white/20 space-y-4">
        {/* View Mode Toggle */}
        <div>
          <label className="text-sm font-brand text-white/90 block mb-2">View Mode</label>
        ...
        {/* Sort By */}
        <div>
          <label className="text-sm font-brand text-white/90 block mb-2">Sort By</label>
          <select
            value={sortKey}
            onChange={async (e) => {
        ...
        {/* Default Cover Style */}
        <div>
          <label className="text-sm font-brand text-white/90 block mb-2">Default Cover Style</label>
          <select
