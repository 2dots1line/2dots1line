...
- **Backend:**
  ...
  - API Gateway exposes `/api/v1/graph-projection` for fetching the latest projection for a user.

- **Frontend:**
  - `cosmosService.ts` fetches the projection JSON.
