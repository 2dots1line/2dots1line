...
│   └── dimension-reducer/                 # UMAP/t-SNE service (Port 8000)
...
INFRASTRUCTURE_SERVICES:
  ...
  dimension-reducer:        # Port 8000 (Python FastAPI)
    docker: true
    type: "python-service"
```
...
module.exports = {
  apps: [
    ...
    // Python Services
    {
      ...
      args: ['app.py'],
      cwd: './py-services/dimension-reducer',
      instances: 1,
      env: {
        PORT: '8000',
        VIRTUAL_ENV: './venv',
...
# Workers (managed by PM2 or individually)
